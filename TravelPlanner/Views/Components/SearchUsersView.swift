...
struct SearchUsersView: View {
    ...
    @State private var selectedParticipants: [UserInformation] = []
    ...
    var body: some View {
            ...
            VStack {
                ...
                VStack {
                    ...
                    if !participantViewModel.searchResults.isEmpty {
                        ...
                        let participantIds = Set(participantViewModel.participants.map { $0.userId })
                ...
                Button(action: {
                    if selectedParticipants.isEmpty {
                        ...
                        participantViewModel.addMultipleParticipants(tripId: tripId, users: selectedParticipants) { successCount in
        ...
        .overlay(
            Group {
                if showErrorToast {
                    ToastView(message: errorToastMessage, type: .error)
                }
            },
            alignment: .bottom
        )
